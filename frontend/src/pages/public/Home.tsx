  ...
  return (
    <div className="flex flex-col items-center gap-6 py-20 text-center">
      ...
      <div className="flex gap-3">
        ...
        <Link
          to="/register"
          className="rounded-md bg-gray-100 dark:bg-gray-800 px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-700"
        >
          {t("auth.register")}
        </Link>
      </div>
